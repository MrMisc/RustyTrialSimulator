...
| Primary method | User behaviour                                                                                                                                                                                                                                                                                                | Pity system (2 fails)                        | Reinforcement System (N successes)                                                                                         | Explicit Conditions                                                                                                                                                                                        | Method Numbers  (user input)      |
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|
| 1              | Multiple attempts per seed to finish  Terminate each attempt at fixed number of attempts                                                                                                                                                                                                                      | Yes  Does NOT apply at (*) fixed boundaries  | No                                                                                                                         | method_number%10 = 1  method_number<100  Method number must be below 100 and have 1 in the ones place                                                                                                      | 1                                 |
| 2              | Multiple attempts per seed to finish  Terminate each attempt at fixed number of failures accumulated                                                                                                                                                                                                          | Yes  Does NOT apply at (*) fixed boundaries  | No                                                                                                                         | method_number%10 = 2  method_number<100  Method number must be  below 100 and have 2 in the ones place                                                                                                     | 2                                 |
| 3              | Multiple attempts per seed to finish  Terminate each attempt after fixed number attempts  UNLESS attempt has resulted in a net positive increment in level on series of successive trials. At that point , use method 2 logic and stop only after receiving a  fixed number of failures (falsecap parameter). | Yes   Does NOT apply at (*) fixed boundaries | No                                                                                                                         | method_number%10 = 3  method_number<100  Method number must be  below 100 and have 3 in the ones place                                                                                                     | 3                                 |
| 4              | None                                                                                                                                                                                                                                                                                                          | Yes   Does NOT apply at (*) fixed boundaries | No                                                                                                                         | method_number%10 = 4  method_number<100  Method number must be below 100 and have 4 in the ones place                                                                                                      | 4 14 24 ...  94                   |
| 5-9            | None                                                                                                                                                                                                                                                                                                          | Yes  DOES apply at (*)  fixed boundaries     | No                                                                                                                         | method_number<100  Pity system allocation method_number%100<10  !(method_number%10=1,2,3)  Method number must  not follow the above  patterns but be below 100. Also does not fall under previous criteria | 5-9                               |
| 10             | None                                                                                                                                                                                                                                                                                                          | No                                           | No                                                                                                                         | Remaining in the tens                                                                                                                                                                                      | 10 20 30 ... 90                   |
| 11 (1)         | Multiple attempts per seed to finish  Terminate each attempt at fixed number of attempts                                                                                                                                                                                                                      | No                                           | No                                                                                                                         | Same as Method 1                                                                                                                                                                                           | 11 21 31 ... 91                   |
| 12 (2)         | Multiple attempts per seed to finish  Terminate each attempt at fixed number of failures accumulated                                                                                                                                                                                                          | No                                           | No                                                                                                                         | Same as Method 2                                                                                                                                                                                           | 12 22 ...  92                     |
| 13 (3)         | Multiple attempts per seed to finish  Terminate each attempt at fixed number of attempts  UNLESS attempt has resulted in net positive increment. At that point, use method 2 logic.                                                                                                                           | No                                           | No                                                                                                                         | Same as Method 3                                                                                                                                                                                           | 13  23 ...  93                    |
| %4-%9          | None                                                                                                                                                                                                                                                                                                          | No                                           | No                                                                                                                         | method_number<100                                                                                                                                                                                          | 14,15..20 24,25..30 ... 94,95..99 |
| 100-109        | Method 1;  Multiple attempts per session  Terminate each attempt at fixed number of attempts                                                                                                                                                                                                                  | Yes                                          | Yes  Automatic successful trial upon  N successful trials in a row  N is the value of the first digit of the method number | Condition N = method_number%100  Reinforcement series method_number>=100  User behaviour method_number/100=1  Pity system method_number%100<10                                                             |                                   |
| 110-199        | Method 1;  Multiple attempts per session  Terminate each attempt at fixed number of attempts                                                                                                                                                                                                                  | No                                           | Yes                                                                                                                        | Condition N = method_number%100  Reinforcement series method_number>=100  User behaviour method_number/100=1                                                                                               |                                   |
|                |                                                                                                                                                                                                                                                                                                               |                                              |                                                                                                                            |                                                                                                                                                                                                            |                                   |
|                |                                                                                                                                                                                                                                                                                                               |                                              |                                                                                                                            |                                                                                                                                                                                                            |                                   |
